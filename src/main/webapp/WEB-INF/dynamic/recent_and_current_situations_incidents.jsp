...
<div class="container">
    ...
    <div class="jumbotron">
            ...
            <div class="col-sm-6">
                <form action="authorizeLogin" method="post">
                    <a href="getRecentCurrentIncidentsSituationsPage" button type="submit" class="btn btn-warning">
                        <h3>Discrimination and Racism</h3></abutton> </a>
                </form>
            </div>
            <div class="col-sm-6">
                <form action="authorizeLogin" method="post">
                    <a href="getDataAndGraphPage" button type="submit" class="btn btn-warning">
        ...
        Although Rabbi Yosef "had in 1973 recognised the Beta Israel as Jews, he demanded that they undergo a conversion ceremony to remove
        all doubt" (Zegeye 379). Israel Jews were caught in surprise seeing how different the Bete Israel were; the Felashas did not wear
        "kippot (skullcaps)", tefillin (small leather boxes)—neither did they know Israel's holidays like Purim and Hanukkah (Zegeye 376).
        Those who refused to readjust their belief system or "convert were not allowed to be married by the rabbinate" (Zegeye 379).
        "In the early years after Operation Moses (1984) and Operation Solomon (1991), Sephardic Chief Rabbi David Shloush was the only
        one who could act as marriage registrar for the Ethiopian community, should they not choose to undergo a symbolic conversion
        first" (Zegeye 378). Indeed, the qessotch (kessim in Hebrew), Bete Israel leaders, fought very hard to get full rabbinic
        ...
        skin color (Ojanuga). He concluded that discrimination based on skin color was not a problem; however, 31 percent of
